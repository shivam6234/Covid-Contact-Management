...
const CovidRecoveryGraph: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="hidden md:hidden lg:flex h-auto bg-yellow-100 flex-col mt-10" style={{ height: '65vh', width: '100%' }}>
        <h1 className="mb-5 text-center text-3xl underline font-bold">Covid-19 Recovery Data</h1>
      ...
      <div className="flex md:hidden lg:hidden h-auto bg-yellow-100 flex-col " style={{ height: '50vh', width: '100%' }}>
        <h1 className="mb-5 text-center text-xl underline font-bold">Covid-19 Recovery Data</h1>
...
export default CovidRecoveryGraph;